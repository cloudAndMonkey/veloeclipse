...
public class DTDAttribute implements DTDOutput
{
     ...
     */
    private static final long serialVersionUID = 3258688793216365622L;
    ...
    {
        if (!(aType instanceof String) && !(aType instanceof DTDEnumeration) && !(aType instanceof DTDNotationList)) { throw new IllegalArgumentException(

 ...
 */
public class DTDElement implements DTDOutput, Serializable
{

    /**
     * Comment for <code>serialVersionUID</code>
     */
    private static final long serialVersionUID = 3977579212468925490L;
    ...
    public void write(PrintWriter out) throws IOException
    {
        ...
        out.println();
        /*
         * if (attributes.size() > 0) { out.print(" <!ATTLIST ");
         * out.println(name); TreeMap tm=new TreeMap(attributes); Collection
         * values=tm.values(); Iterator iterator=values.iterator(); while
         * (iterator.hasNext()) { out.print(" "); DTDAttribute attr =
         * (DTDAttribute) iterator.next(); attr.write(out); if
         * (iterator.hasNext()) out.println(); else out.println(">"); } }
         */
    }
